...
python interpret_with_password.py --config_yaml ${root_path}/experiments/password/process/process_Llama-2-7b-hf.yaml --root_path ${root_path} --root_path ${root_path}
